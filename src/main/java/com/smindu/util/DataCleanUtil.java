...
public class DataCleanUtil extends UDF {

	public static final String[] need_replace_blank_list = { " ", "\\.","？","！","\\*" ,""};
	// 不带调试打印语句
...
//		System.out.println(getDays("1年"));
//		System.out.println(getDays("一个余年三个月")); // 455 ok
//		System.out.println(getDays("十二个余年"));
		System.out.println(replace2Blank(" 3月.？！*"));
		String str = "2322中国..？！";
		System.out.println(str.replaceAll("[\\x00-\\x1F]", ""));
//		System.out.println("3月贷款的事!！？怎么样了".replaceAll("[^0-9a-zA-Z\\\\u4e00-\\\\u9fa5]", ""));
	}
...
//				return final_days;
	...
	public static String replace2Blank(String str) {
		...
		for(String replace_str:need_replace_blank_list){
//			System.out.println(replace_str); // 个, 余

			// 根据替换列表中的每个字符串，替换掉为空白。
			str = str.replaceAll(replace_str,"");
